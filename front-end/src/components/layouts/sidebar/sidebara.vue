    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <nav class="mt-10">
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'admins' ? activeClass : inactiveClass]" to="/admins">
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'look_recieptionist' ? activeClass : inactiveClass]" to="/look_recieptionist">
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">look patient</span>
        </router-link>
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'user' ? activeClass : inactiveClass]" to="/look_users">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path
