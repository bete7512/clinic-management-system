      ...
      >
        ...
        <nav class="mt-10">
          <router-link
            ...
            :class="[$route.name === 'doctors' ? activeClass : inactiveClass]"
            to="/doctors"
          >
            <svg
              class="w-5 h-5"
            ...
            <span class="mx-4">Doctors</span>
          </router-link>
  
          <router-link
            class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
            :class="[$route.name === 'queue' ? activeClass : inactiveClass]"
            to='/queue_orders'
          >
            <svg
              class="w-5 h-5"
          ...
          >
            ...
            <span class="mx-4">patient history</span>
          </router-link>
 
          <router-link
            class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
            :class="[$route.name === 'addhistory' ? activeClass : inactiveClass]"
            to='/addhistory'
          >
