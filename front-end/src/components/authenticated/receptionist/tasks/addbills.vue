        ...
        <div class="w-1/3">
            <Form class=" justify-center space-y-6 bg-cyan-400 p-10 rounded w-full  items-center  p-b-10 px-10"
                ...
                <div class="space-y-10">
                    <div v-for="pay in pays" :key="pay" class="flex space-x-3">
                        <div class="space-y-3 ">
                            <label>issues</label>
                            <input name="address" type="text" v-model="address" placeholder="Enter issues"
                                class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" />
                        </div>
                        <div class="space-y-3">
                                <label>price</label>
                                <input name="address" type="text" v-model="address" placeholder="Enter address"
                                    class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" />
                        </div>
                    </div>
                    <div><button @click="pays++"
                            class="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">add
                            another issues</button></div>
                    <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <Field name="pid" type="text" v-model="pid" placeholder="enter order number"
                            class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                            :class="{ 'is-invalid': errors.pid }" />
                        <div class="text-red-700">{{errors.pid}}</div>
                    </div>
                </div>
